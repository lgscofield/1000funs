			...
			<div class="span12">
				<div class="querybar">
					<div class="row-fluid">
						...
						<div class="span4">
							<label for="auto_checkbox" class="checkbox ios pull-right">
								<span>自动出单</span>
								<div class="ios">
									<input id="auto_checkbox" type="checkbox"><i></i>
								</div>
							</label>
						</div>
					</div>
								...
								<div class="row-fluid body">
									<div>
										...
										<span class="order-time">
											预计送达时间: 11:00 (下单时间: 9:30)
										</span>
										<!-- <input type="button" class="btn btn-mini btn-primary order-btn-out" value="出单"> -->
									</div>
